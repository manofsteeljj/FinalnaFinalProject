                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <button class="edit_btn" onclick="window.location.href='/finalnafinalproject-1/public/index.php?action=edit_faci&id=<?= $facility['id'] ?>'">Edit</button>
                                <button class="delete_btn" onclick="window.location.href='/finalnafinalproject-1/public/index.php?action=del_faci&id=<?= $facility['id'] ?>'">Delete</button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
